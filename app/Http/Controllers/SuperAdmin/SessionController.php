...
//            $sessions=$sessions->where('status', $request->status);
    ...
    private function getClinicSessionDetails($request, $id){
        ...
        $session=BookingSlot::with(['clinic','assignedTo', 'review', 'therapy', 'diseases', 'painpoints','treatmentsGiven', 'timeslot', 'order'])->findOrFail($id);
    ...
    private function getTherapySessionDetails($request, $id){
        $session=HomeBookingSlots::with(['assignedTo', 'review', 'therapy', 'diseases', 'painpoints','treatmentsGiven', 'timeslot', 'order'])->findOrFail($id);

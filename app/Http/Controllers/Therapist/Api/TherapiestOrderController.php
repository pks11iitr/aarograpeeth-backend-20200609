...
//        }
        ...
        return [
            ...
            'age'=>$openbookingdetails->age??'',
            'gender'=>$openbookingdetails->gender??'',
            'occupation'=>$openbookingdetails->occupation??'',
            'height'=>$openbookingdetails->height??'',
            'weight'=>$openbookingdetails->weight??'',
            'pulse'=>$openbookingdetails->pulse??'',
            'temperature'=>$openbookingdetails->temperature??'',
            'sugar'=>$openbookingdetails->sugar??'',
            'blood_pressure'=>$openbookingdetails->blood_pressure??'',
            'blood_group'=>$openbookingdetails->blood_group??'',
            /*'data' =>$openbookingdetails,*/
        ];
